   ...
   .error{
      ...
      <main>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="page__title-content text-center">
                        <h3 class="breadcrumb-title breadcrumb-title-sd mb-15">register</h3>
         ...
         <div class="checkout-area pb-85">
            <div class="container">
                <form  method="post" action="{{ route('store') }}" class="container" style="margin-top: 50px;" >
                  @csrf
                        ...
                        <div class="col-lg-12">
                            <div class="checkbox-form">
                                ...
                                <div class="row">
                                            ...
                                            <x-inputcomponet type="text" name="fname" label="fname" />
                                            <x-inputcomponet type="text" name="lname" label="lname" />
                                            <x-inputcomponet type="text" name="enroll" label="enroll" />
                                            <x-inputcomponet type="text" name="branch" label="branch" />
                                            <x-inputcomponet type="text" name="address" label="address" />
                              ...
                              @endforeach 
                                    ...
                                    <x-inputcomponet type="text" name="phone" label="phone" />
                                    ...
                                    <x-inputcomponet type="text" name="password" label="password" />
                                    <x-inputcomponet type="text" name="pconfirmation" label="pconfirmation" />
